...
public interface IRichSpout extends IStreamSource {
	 ...
	 * cluster. It provides the spout with the environment in which the spout
	 * executes.
	 * 
	 * @param config    The Storm configuration for this spout. This is the
	 *                  configuration provided to the topology merged in with
	 *                  cluster configuration on this machine.
	 * @param topo
	 * @param collector The collector is used to emit tuples from this spout. Tuples
	 ...
	 * close will be called, because the supervisor kill -9’s worker processes on
	 * the cluster.
	 */
	public void close();
	 ...
	 * no tuples to emit, this method should return.
	 */
